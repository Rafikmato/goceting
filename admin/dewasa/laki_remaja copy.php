    ...
    <div class="row">
      ...
      <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select id="umur" required="" class="form-control custom-select" name="tahun">
                    <option selected disabled value="">-- Pilih Umur --</option>
                    <?php 
                    $query = mysqli_query($koneksi, "SELECT * FROM laki_remaja");
                    while ($d = mysqli_fetch_array($query)) {
                      
                      ?>
                        <option value="<?php echo $d['tahun']; ?>"><?php echo $d['tahun']; ?> Tahun </option>
                        <?php     
                    }
          ...
          <!-- /.card -->
                 ...
                 <?php
                    $query1 = mysqli_query($koneksi, "SELECT * FROM laki_remaja  WHERE tahun = '$tahun' ");
