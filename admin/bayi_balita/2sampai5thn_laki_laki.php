        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Balita Laki-laki</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="row">
      ...
      <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
            	<form action="?module=2sampai5thn_laki_laki" method="POST">
                ...
                <div class="form-group">
                  ...
                  <?php 
                    $query = mysqli_query($koneksi, "SELECT * FROM 2sampai5thn_laki_laki");
          ...
          <!-- /.card -->
                 ...
                 <?php
                    $query1 = mysqli_query($koneksi, "SELECT * FROM 2sampai5thn_laki_laki WHERE pjg_bdn = '$tinggi_badan' ");
