    ...
    <div class="row">
      ...
      <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
            	<form action="?module=perempuan" method="POST">
                ...
                <div class="form-group">
                  ...
                  <?php 
                    ...
                    while ($d = mysqli_fetch_array($query)) {
                      ...
                      ?>
                        <option value="<?php echo $d['panjang_badan']; ?>"><?php echo $d['panjang_badan']; ?> Bulan </option>
                      <?php     
                    }
          ...
          <!-- /.card -->
                 ...
                 <?php
                    $query1 = mysqli_query($koneksi, "SELECT * FROM bayi_balita_perempuan WHERE panjang_badan = '$tinggi_badan' ");
                    ...
                    if ($berat_badan != 0 && $berat_badan <= $kurang3sd) {
                      ?>
                      ...
                      <?php
                    }else if ($berat_badan != 0 && $berat_badan <= $kurang2sd){
                      ?>
                      <div class="row">
                        <div class="col-lg-12 col-12">
                          <!-- small box -->
                      ...
                      <?php
                    }elseif ($berat_badan != 0 && $berat_badan <= $kurang1sd) {
                      ?>
                        <div class="row">
                          <div class="col-lg-12 col-12">
                            <!-- small box -->
                      ...
                      <?php
                    }elseif ($berat_badan != 0 && $berat_badan <= $median) {
                      ?>
                        <div class="row">
                          <div class="col-lg-12 col-12">
                            <!-- small box -->
                      ...
                      <?php
                    }elseif ($berat_badan != 0 && $berat_badan <= $tambah1sd) {
                      ?>
                        <div class="row">
                          <div class="col-lg-12 col-12">
                            <!-- small box -->
                      ...
                      <?php
                    }elseif ($berat_badan != 0 && $berat_badan <= $tambah2sd) {
                      ?>
                        <div class="row">
                          <div class="col-lg-12 col-12">
                            <!-- small box -->
                      ...
                      <?php
                    }elseif ($berat_badan != 0 && $berat_badan <= $tambah3sd) {
                      ?>
                        <div class="row">
                          <div class="col-lg-12 col-12">
                            <!-- small box -->
